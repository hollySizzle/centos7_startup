...
sudo mkdir /home/$username/.ssh || echo ".ssh directory already exists"
sudo chown -R $username:$username .ssh
sudo echo $ssh_open_key | tee -a /home/$username/.ssh/authorized_keys || echo 'authorized_keysの操作に失敗しました'
sudo chown -R $username:$username /home/$username/.ssh

# 所有者以外のアクセスを許可しないようにパーミッションを変更します
sudo chmod 700 /home/$username/.ssh/ || echo '.sshの権限変更に失敗しました'
sudo chmod 600 /home/$username/.ssh/authorized_keys || echo '.ssh/authorized_keysの権限変更に失敗しました'
